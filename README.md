...
This fork provides an implementation for a streamwise-varying profile (using cubic splines) of wall-normal blowing in a turbulent boundary layer. An example input file is provided at `examples/TBL-Wall-Normal-Blowing/input.i3d`.
___
